...
{ 
  ...
  { 
    ...
    { 
      ...
      public int NoOfCellsSouth; //CELLS HERE
    } 
    ...
    { 
      ...
      public Game(Boolean IsATrainingGame) //STARTS HERE
      { 
      ...
      { 
        ...
        { 
          ...
          { 
            ...
            Player.MakeMove(MoveDirection); //input N M E or S
            Cavern.PlaceItem(Player.GetPosition(), '*'); //LOCATION
            Cavern.Display(Monster.GetAwake());
      ...
      public Boolean CheckValidMove(char Direction) //fix here, put else if statements for player direction
      { 
        Boolean ValidMove;
        ValidMove = true; 
        ...
        CellReference pos =  Player.GetPosition();
                ...
                {
                    case 0:
                        if(pos.NoOfCellsSouth -1 < 0);
                        ValidMove = false;
                        break;
                    case 1:
                        if (pos.NoOfCellsSouth + 1 >= 5)
                            ValidMove = false;
                        break;
                    case 2:
